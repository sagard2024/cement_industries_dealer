...
class OrderRetailerListScreen extends StatefulWidget {
  const OrderRetailerListScreen({super.key});

  @override
  State<StatefulWidget> createState() => OrderRetailerListScreenState();
}

class OrderRetailerListScreenState extends State<OrderRetailerListScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Order to Retailer", style: TextStyle(color: textColor, fontSize: 18, fontWeight: FontWeight.w600)),
      ),
      body: ListView(
        children: [
          verticalSpace(7),
